...
//        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.timeView.setText(userEvents.getUpcomingEvents().get(position).getStartTime().toString());
        holder.myTextView.setText(userEvents.getUpcomingEvents().get(position).getTitle());
        holder.descriptionView.setText(userEvents.getUpcomingEvents().get(position).getDescription());
    }

    // total number of rows
    @Override
    public int getItemCount() {
        return userEvents.getUpcomingEvents().size();
    }
    ...
    Event getItem(int id) {
        return userEvents.getUpcomingEvents().get(id);
    }
